---
title: 线段树 - 有改动求解区间最值 - 忠诚2
tags: 码志
publish: 2013-08-27 21:16:00 +08:00
---

忠诚2是忠诚的一个提升版本。我们在之前的一篇文章[线段树 – 无改动求解区间最值 – 忠诚]({{site.paths.posts}}2013/08/27/asegment-tree-1.html)简单的谈了一下关于无改动求解区间最值的问题。现在我们来研究一下有改动求解区间最值。
