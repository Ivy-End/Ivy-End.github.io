...
title: 算法专题：求解线性方程组
tags: 码志
publish: 2013-11-05 20:34:00 +08:00
---
...
首先，我们根据方程组写出增广矩阵。每次都找$$x_{i}$$系数的绝对值最大的那个方程，将它移到上方，而将下面的方程组的$$x_{i}$$的系数全部化成0。以此类推，到最后再逆序求解每个未知数的解。
...
$$\begin{bmatrix}\left.\begin{matrix}2 & 1 & -1\\ -3 & -1 & 2\\ -2 & 1 & 2\end{matrix}\right|\begin{matrix}8\\ -11\\ -3\end{matrix}\end{bmatrix}$$
...
1
\end{matrix}
\end{bmatrix}\\\Rightarrow z=-1,y=3\times\left ( \frac{2}{3}-\frac{1}{3}\times\left ( -1 \right )\right )=3,x=-\frac{1}{3}\times\left ( -11+3-2*\left ( -1 \right ) \right )=2$$
