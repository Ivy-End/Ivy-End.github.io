...
title: 算法专题：不定方程
tags: 码志
publish: 2013-11-04 19:41:00 +08:00
---
...
$$\begin{matrix}23^{1} & 23^{1} & 3^{17} & 3^{17} & 1^{38}\\ 97^{0} & 5^{4} & 5^{4} & 2^{21} & 2^{21}\end{matrix}$$
...
$$\begin{matrix}97^{1} & 5^{1} & 5^{1} & 2^{5} & 2^{5} & \\ 23^{0} & 23^{0} & 3^{4} & 3^{4} & 1^{9} & 1^{14}\end{matrix}$$
...
且$$\gcd\left ( a,b \right )=\gcd\left(b,a\mod b \right )$$。不妨设

$$bx{}'+\left ( a\mod b \right )y{}'=\gcd\left ( b,a\mod b \right )$$

此时就有

$$bx{}'+\left ( a\mod b \right )y{}'=ax+by$$

展开得到

$$bx{}'+\left ( a-\left [ \frac{a}{b} \right ]\cdot b \right )y{}'=ax+by$$

化简得

$$ay{}'+b\left (x{}'-\left [ \frac{a}{b} \right ]\cdot y{}'  \right )=ax+by$$

因此可以得到

$$x=y{}',y=x{}'-\left [ \frac{a}{b} \right ]\cdot y{}'$$
