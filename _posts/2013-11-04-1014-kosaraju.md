---
title: 算法专题：强连通分量 - Kosaraju Algorithm
tags: 码志
publish: 2013-11-04 10:14:00 +08:00
---

强连通分量（Strongly Connected Components），简称SCC。是指在给定的一张图$$G=\left(V,E\right)$$的一个子图$$G{}'=\left(V,E\right)$$这个子图满足对于其中的任意一对点$$\left \langle V_{i},V_{j} \right \rangle$$均存在这样两条路径$$\left \langle V_{i},\cdots,V_{j} \right \rangle,\left \langle V_{j},\cdots,V_{i} \right \rangle$$。
...
![SCC]({{site.paths.image}}2013/SCC.png "SCC")
