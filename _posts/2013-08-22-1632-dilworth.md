---
title: Dilworth定理 - NOIP1999T1
tags: 码志
publish: 2013-08-22 16:32:00 +08:00
---

题目是经典的导弹拦截。第一问很有信心的写下了最长非增序列。第二问就懵了。后来看了题解，有一个「Dilworth定理」，现在将定理的表述和证明整理如下：
...
在偏序集中，有一个非常著名的定理，叫做「Dilworth定理」。在介绍这个定理之前，我们需要介绍几个术语：
...
**定理2（Dilworth定理）**：令$$\left ( \textbf{A},\leq \right )$$是一个有限偏序集，并令$$m$$是反链的最大的大小。则$$\textbf{X}$$可以被划分成$$m$$个但不能再少的链。
...
那么这道题目就化简为求一遍最长非增序列和最长上升序列，DP即可。
