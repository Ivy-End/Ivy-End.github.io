---
title: 线段树 – 无改动求解区间最值 – 忠诚
tags: 码志
publish: 2013-08-27 21:06:00 +08:00
---

昨天研究了一下线段树，发现原来线段树有这么多实现方式。当然，对于非递归自底向上线段树，俗称ZKW线段树还是不太理解。而且我的实现方式还是用的指针，所以效率不是特别高。首先记录一下自己对于线段树的理解吧。我们用忠诚这道题目来做例子。

线段树可以直观的表示为下面这张图：

![线段树]({{site.paths.image}}2013/Segment-Tree.jpg "线段树")
